      ...
      <div className="contenedor">
        <div className="title">
          ...
          <p>
            ...
            <hr/>
            Find me on <a href="https://www.linkedin.com/in/cristian-nicolas-castagnetto-full-stack-dev/" target="_BLANK" rel="noreferrer" className="linkhome">LinkedIn</a> and <a href="https://github.com/cNikoc" target="_BLANK" rel="noreferrer" className="linkhome">GitHub</a>.
          </p>
        </div>
